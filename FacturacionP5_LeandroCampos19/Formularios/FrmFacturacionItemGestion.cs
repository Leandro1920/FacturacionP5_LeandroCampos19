    ...
    public partial class FrmFacturacionItemGestion : Form
    {
        ...
        private void BtnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (ValidadItem())
            {
                ...
                //como el formulario de facturación es global y dentro de él tenemos un datatable con la estructura
                ...
                //una vez que se han alimentado los datos base para la línea, se prodece a adjuntarla al datatable de detalles
        ...
        private bool ValidadItem()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Debe seleccionar un Item de la lista!", "Error de valición", MessageBoxButtons.OK);
                    return false;
                }

                if (TxtCantidad.Value == 0)
                {
                    MessageBox.Show("La cantidad no puede ser cero", "Error de valición", MessageBoxButtons.OK);
                    return false;
                }
            }
            return R;
